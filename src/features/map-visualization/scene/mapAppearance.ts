 ...
 *    之间线性淡出，独占区名称比仓库名称可见范围更大（SPEC §2.3 远距离隐藏）。
 */
...
/** 独占区蓝色外沿条带总宽度（比路面 0.5m 宽出蓝色边缘，SPEC §2.3） */
export const EXCLUSIVE_OUTLINE_WIDTH_M = 0.9
...
/** 充电桩底部光环：内半径略小于节点圆盘，外半径露出青色圆环 */
export const CHARGE_RING_INNER_M = 0.42
...
/** 名称文字颜色：仓库浅黄、独占区浅蓝、停车符号白色（紫色方垫之上） */
export const WAREHOUSE_NAME_COLOR = '#f2e3a1'
...
export const WAREHOUSE_NAME_HEIGHT_M = 0.9
export const GROUP_NAME_HEIGHT_M = 1.6
export const PARK_GLYPH_HEIGHT_M = 0.8

/** 仓库名称距离显隐区间（米）：近于 near 全显，远于 far 隐藏 */
export const WAREHOUSE_NAME_FADE_NEAR_M = 30
export const WAREHOUSE_NAME_FADE_FAR_M = 70
